...
// Dữ liệu giả lập (Thêm trạng thái Sale, Mới, Hot)
$categories = [
    'all' => ['icon' => 'layout-grid', 'name' => 'Tất cả'],
    'ban-hang' => ['icon' => 'shopping-bag', 'name' => 'Bán hàng'],
    'bds' => ['icon' => 'building-2', 'name' => 'Bất động sản'],
    'doanh-nghiep' => ['icon' => 'briefcase', 'name' => 'Doanh nghiệp'],
    'landing' => ['icon' => 'rocket', 'name' => 'Landing Page'],
    'blog' => ['icon' => 'newspaper', 'name' => 'Blog/Tin tức']
];
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto font-light">
                ...
                Được thiết kế để tối đa hóa tỷ lệ chuyển đổi khách hàng.
            </p>
            ...
            <div class="relative max-w-2xl mx-auto group">
                ...
                <div class="relative flex items-center bg-slate-800 rounded-full p-2 border border-slate-700 shadow-2xl">
                    ...
                    <input type="text" placeholder="Bạn đang tìm mẫu web gì? (VD: Thời trang, Nội thất...)" 
...
<section class="py-16 bg-slate-50 min-h-screen relative">
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="sticky top-[80px] z-30 mb-12 py-4 bg-slate-50/95 backdrop-blur-sm transition-all">
            <div class="flex overflow-x-auto gap-3 pb-2 scrollbar-hide md:justify-center">
                <?php foreach($categories as $key => $cat): ?>
                    <a href="?cat=<?= $key ?>" 
                       ...
                       ?>">
                       <i data-lucide="<?= $cat['icon'] ?>" class="w-4 h-4 <?= $key === 'all' ? 'text-orange-500' : 'text-slate-400 group-hover:text-orange-500' ?>"></i>
                       <?= $cat['name'] ?>
                    </a>
                <?php endforeach; ?>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group relative flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-2xl hover:shadow-orange-500/10 hover:-translate-y-2 transition-all duration-500">
                ...
                <div class="relative overflow-hidden aspect-[4/3] bg-slate-200 group-hover:rounded-b-none transition-all">
                    <?php if($item['tag']): 
                        $badgeColor = match($item['tag_color']) {
                    ...
                    ?>
                        <div class="absolute top-4 left-4 z-20 <?= $badgeColor ?> text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-lg uppercase tracking-wider">
                            <?= $item['tag'] ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 backdrop-blur-[2px] flex items-center justify-center gap-3">
                        <a href="#" class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-slate-900 hover:text-orange-600 hover:scale-110 transition-all shadow-xl" title="Xem Demo Live">
                            <i data-lucide="eye" class="w-5 h-5"></i>
                        </a>
                        <a href="/kho-giao-dien/<?= $item['id'] ?>" class="w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center text-white hover:bg-orange-700 hover:scale-110 transition-all shadow-xl shadow-orange-600/40" title="Xem chi tiết">
                ...
                <div class="p-6 flex flex-col flex-1 relative">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-2 leading-tight group-hover:text-orange-600 transition-colors">
                        <a href="/kho-giao-dien/<?= $item['id'] ?>"><?= $item['name'] ?></a>
                    </h3>
                    ...
                    <div class="mt-auto flex items-end justify-between">
                        ...
                        <a href="/lien-he" class="group/btn flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-50 text-slate-700 font-bold text-sm hover:bg-slate-900 hover:text-white transition-all">
                            <span>Mua ngay</span>
                            <i data-lucide="shopping-bag" class="w-4 h-4 group-hover/btn:-translate-y-0.5 transition-transform"></i>
                        </a>
                    </div>
                </div>
...
<section class="py-24 bg-white border-t border-slate-100 relative overflow-hidden">
    <div class="container mx-auto px-4">
        <div class="relative bg-gradient-to-r from-orange-500 to-pink-600 rounded-[2.5rem] p-12 md:p-20 overflow-hidden text-center shadow-2xl shadow-orange-500/30">
            ...
            <div class="absolute -bottom-24 -right-24 w-64 h-64 bg-yellow-300 opacity-20 rounded-full blur-3xl"></div>

            <div class="relative z-10 max-w-3xl mx-auto">
                <h2 class="text-3xl md:text-5xl font-extrabold text-white mb-6">
                    Không tìm thấy mẫu ưng ý?
                </h2>
                <p class="text-orange-50 text-lg mb-10 leading-relaxed">
                    Mỗi doanh nghiệp đều có câu chuyện riêng. Hãy để chúng tôi thiết kế một giao diện <strong>Độc quyền - Duy nhất</strong> cho thương hiệu của bạn.
                </p>
                
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="/lien-he" class="px-8 py-4 bg-white text-orange-600 font-bold rounded-full shadow-xl hover:bg-slate-900 hover:text-white transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2">
