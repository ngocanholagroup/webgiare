...
<div id="tab-posts" class="tab-panel active space-y-6">
    ...
    $post_columns = [
        ...
        [
            ...
            'type' => 'status',
            'map' => [
                '1' => ['Published', 'text-green-700'],
                '0' => ['Draft', 'text-slate-500']
            ]
        ],
        [
            'label' => 'Hành động', 
            'type' => 'actions', 
            'class' => 'text-right',
            'edit_url' => '/admin/blog/edit/:id', 
            'delete_url' => '/admin/blog/delete/:id'
        ]
    ];
    ...
    $search_placeholder = 'Tìm tiêu đề bài viết...';
...
<div id="tab-categories" class="tab-panel space-y-6">
    ...
    $cat_columns = [
        ...
        [
            'label' => 'Slug', 
            'key' => 'slug',
            'class' => 'font-mono text-slate-500 text-sm'
        ],
        [
            'label' => 'Số bài', 
            'key' => 'total_posts',
        ...
        [
            ...
            'type' => 'actions', 
            'class' => 'text-right',
            'edit_url' => '/admin/blog-category/edit/:id', 
            'delete_url' => '/admin/blog-category/delete/:id'
        ]
    ];
    ...
    $pagination = ['current' => 1, 'total' => 1]; // Danh mục thường ít nên không cần phân trang phức tạp
...
<div id="tab-authors" class="tab-panel space-y-6">
    ...
    $auth_columns = [
        ...
        [
            ...
            'callback' => function($row) {
                ...
                return '<div class="flex items-center gap-3">
                            <img src="'.$avatar.'" class="w-8 h-8 rounded-full object-cover border border-slate-200">
        ...
        [
            ...
            'type' => 'custom',
            'callback' => function($row) {
                return '<span class="text-slate-500 truncate block max-w-xs" title="'.htmlspecialchars($row['bio']).'">' 
        ...
        [
            ...
            'type' => 'actions', 
            'class' => 'text-right',
            'edit_url' => '/admin/author/edit/:id', 
            'delete_url' => '/admin/author/delete/:id'
        ]
    ];
    ...
    $search_placeholder = 'Tìm tác giả...';
